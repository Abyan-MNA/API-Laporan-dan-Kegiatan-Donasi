...
- `GET /data-kegatan-sosial`

  request ini akan mengembalikan json kegiatan sosial dengan limit 10.
  ...
  "data": [
    {
      "id": 3,
      "judul": "1 Suro 1447: testttttt",
      "deskripsi": "Syuroan",
      "lokasi": "Di manapun, Hibrid",
      "tanggal_mulai": "2025-06-20T00:00:00.000Z",
...
- `GET /data-kegatan-sosial?id=:id`
  ...
  `:id` adalah query parameter di mana berdasarkan ID di dalam tabel `kegiatan` (lihat di skema database).
  ...
  ```js
  {
    ...
    "data": {
      ...
      "deskripsi": "Kegiatan sosial untuk membantu masyarakat yang membutuhkan.",
      "lokasi": "Jakarta",
      "tanggal_mulai": "2023-10-01T00:00:00.000Z",
      "tanggal_selesai": "2023-10-31T00:00:00.000Z",
      "status": "draf"
    }
  }
  ```
...
- `PATCH /data-kegiatan-sosial/?id=:id` (Untuk update sebagian kolom rekaman data)
  ...
  ```json
  {
    "status": "selesai" // String: [ "draft", "accepted", "selesai", "rejected" ]
  }
  ```
